...
```python
{
  ...
  "task_description": str,  # What to scaffold
  "input_data": {
    "feature_name": str,  # Name of feature/component
    "tech_stack": List[str],  # Technologies to use
    "patterns": List[str],  # Design patterns to follow
    "include_tests": bool,  # Whether to generate tests
  }
}
```
...
```python
{
  ...
  "output_data": {
    ...
    "structure": dict,  # Project structure tree
...
{
  "project_id": str,
  "task_description": str,  # What to review
  "input_data": {
